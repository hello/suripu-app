...
public class TokenChecker implements Runnable {
  ...
  public TokenChecker(final DeviceDAO deviceDAO,
  ...
  public Runnable createNewWithAccessToken(final AccessToken accessToken) {
    final TokenChecker checker = new TokenChecker(deviceDAO, expansionConfig, expansionStore, externalTokenStore, expansionDataStore, mapper);
    checker.setAccessToken(accessToken);
    return checker;
  }
